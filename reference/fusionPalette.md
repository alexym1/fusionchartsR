...
- drawFullAreaBorder:
  ...
  To set the top border of the area chart (only works if showPlotBorder
  = TRUE)
...
- plotBorderHoverDashGap:
  ...
  Set the gap between two consecutive dashes for all data plots on
  hover(in pixels)
